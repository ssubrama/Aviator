...
class CONTENT_EXPORT RenderFrameImpl
 ...
 private:
  ...
  /************************* Aviator for Referrer - champion *********************/
 
  bool  RemoveReferrer(GURL HostURL, GURL ReferrerURL); // champion - Add Referrer
  bool  IsSameDomain(std::string host_url,std::string referrer_url);// champion - Add Referrer
  std::string GetDomain(std::string host_url);// champion - Add Referrer
  bool isPresent(bool Allow_Or_Block,std::string referrerurl);	// champion - Add Referrer
