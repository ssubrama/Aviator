...
int DownloadItemImpl::championDownloadCount = 0; // champion: Changes for downlaod crash (Navneet)
...
void DownloadItemImpl::Start(
  ...
  DownloadItemImpl::championDownloadCount ++; // champion: Changes for downlaod crash (Navneet)
