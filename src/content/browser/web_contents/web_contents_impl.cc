...
//const char kChromeUIHomePageURL1[]="https://www.whitehatsec.com/securebrowser";//strHomePageURL.c_str();  //Added for champion for Focus on Home Page
  const char kChromeUIHomePageURL1[]=HOMEPAGE_URL;//strHomePageURL.c_str();  //Added for champion for Focus on Home Page
}
...
bool WebContentsImpl::FocusLocationBarByDefault() {
  ...
  if (entry && (entry->GetURL() == GURL(chrome::kChromeUIHomePageURL1)))// || entry->GetURL() == GURL("https://www.google.co.in/"))) // champion added for Focus_location_bar -kAboutBlankURL
    return true;
