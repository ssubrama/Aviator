...
class ChildProcessSecurityPolicyTest : public testing::Test {
 public:
  ...
  virtual void SetUp() {
    ...
    // Claim to always handle aviator:// URLs because the CPSP's notion of
...
TEST_F(ChildProcessSecurityPolicyTest, AboutTest) {
  ...
  // These requests for aviator:// pages should be granted.
  GURL chrome_url("aviator://foo");
...
TEST_F(ChildProcessSecurityPolicyTest, CanServiceWebUIBindings) {
  ...
  GURL url("aviator://thumb/http://www.google.com/");
