...
std::vector<std::string>* net::HttpUtil::AllowVector = new std::vector <std::string>; // champion
std::vector<std::string>* net::HttpUtil::BlockVector = new std::vector <std::string>; // champion
