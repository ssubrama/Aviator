...
class NET_EXPORT HttpRequestHeaders {
 public:
  ...
  static void Insert(int allow, std::string pattern);
  static void RemoveException (int allow, std::string pattern); 
  //bool Checkvalue(bool allow, std::string key);
  //static bool GetStauusofEnableReferrer;
  //purge referrer champion//
