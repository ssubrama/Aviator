...
function getProfileAvatarIcon(path) {
  var chromeThemePath = 'aviator://theme';
  var isDefaultAvatar =
...
/**
 * Generates a CSS -webkit-image-set for a aviator:// url.
...
function getFaviconImageSet(url, opt_size, opt_type) {
  ...
  return imageset(
      'aviator://' + type + '/size/' + size + '@scalefactorx/' + url);
}
