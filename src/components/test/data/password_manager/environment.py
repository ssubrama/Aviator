...
# Message strings to look for in aviator://password-manager-internals
...
class Environment:
  ...
  def __init__(self, chrome_path, chromedriver_path, profile_path,
    ...
    self.internals_page = "aviator://password-manager-internals/"
    # The Website window.
  ...
  def RemoveAllPasswords(self):
    ...
    logging.info("\nRemoveAllPasswords\n")
    self.driver.get("aviator://settings/passwords")
  ...
  def OpenTabAndGoToInternals(self, url):
    ...
    self.driver.get("aviator://newtab")
