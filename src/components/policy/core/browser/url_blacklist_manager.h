...
class POLICY_EXPORT URLBlacklist {
 public:
  ...
  // champion
  void InitConnectionControlObject();
 ...
 private:
  ...
  scoped_ptr<url_matcher::URLMatcher> url_matcher_;
      ...
      // The connection control object
  // scoped_ptr<policy::ConnectionControlManager> ConnectionControlobj_; // champion
 policy::ConnectionControlManager* ConnectionControlobj_ = NULL; // champion
