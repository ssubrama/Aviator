...
static const SegmentCase segment_cases[] = {
  ...
  { "aviator://host/path?query#ref", "chrome",
    url::Component(0, 6), // scheme
    url::Component(), // username
    url::Component(), // password
...
struct FixupCase {
  ...
  {"about:", "aviator://version/"},
  {"about:foo", "aviator://foo/"},
  {"about:version", "aviator://version/"},
  {"about:blank", "about:blank"},
  {"about:usr:pwd@hst/pth?qry#ref", "aviator://usr:pwd@hst/pth?qry#ref"},
  {"about://usr:pwd@hst/pth?qry#ref", "aviator://usr:pwd@hst/pth?qry#ref"},
  {"chrome:usr:pwd@hst/pth?qry#ref", "aviator://usr:pwd@hst/pth?qry#ref"},
  {"aviator://usr:pwd@hst/pth?qry#ref", "aviator://usr:pwd@hst/pth?qry#ref"},
