...
enum SearchEngineType {
  ...
  SEARCH_ENGINE_DUCKDUCKGO,// added champion_duckduckgo
  SEARCH_ENGINE_DUCKDUCKGO_DISCONNECT,//champion - Add for disconnect search
  SEARCH_ENGINE_GOOGLE_DISCONNECT,
  SEARCH_ENGINE_YAHOO_DISCONNECT,
  SEARCH_ENGINE_BING_DISCONNECT,
