...
bool OSCrypt::EncryptString(const std::string& plaintext,
  ...
  crypto::SymmetricKey* encryption_key = NULL;//champion. 
  //champion - Keychain (Dinesh)
  if(prefs && prefs->GetBoolean(prefs::kNotificationKeyChainAccess)) {
  //NSLog(@" In Dinesh start %d", prefs->GetBoolean(prefs::kNotificationKeyChainAccess)); 
