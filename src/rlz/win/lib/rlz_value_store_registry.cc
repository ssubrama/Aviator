...
//
const char kLibKeyName[]               = "Software\\WhiteHat\\Aviator\\Common\\Rlz";
const wchar_t kGoogleKeyName[]         = L"Software\\WhiteHat\\Aviator"; // champion : app name change (amresh)
const wchar_t kGoogleCommonKeyName[]   = L"Software\\WhiteHat\\Aviator\\Common";
