...
# champion : c4996 warning disabled (amresh)
{
    ...
    'variables': {
      'variables': {
        'variables': {
          ...
          'branding%': 'Aviator', # champion : branding (amresh)
      ...
      'buildtype%': '<(buildtype)',
      'branding%': 'Aviator', # champion Aviator Appname change
      ...
      ['OS=="mac" or OS=="ios"', {
        ...
        'conditions': [
          ...
          ['branding=="Chrome"', {
            ...
            'mac_product_name%': 'Aviator', # champion Aviator App name change
          }],
        ...
        'conditions': [
          ...
          [ 'OS=="win" and component=="shared_library"', {
            'msvs_disabled_warnings': [
              4251, 4996, # class 'std::xx' needs to have dll-interface.
            ],
          }],
          [ 'OS=="mac" or OS=="ios"', {
            'xcode_settings': {
    ...
    ['OS=="win"', {
      'target_defaults': {
        ...
        'conditions': [
		  ...
		  # champion : build workaround for 2013
		  ['MSVS_VERSION=="2013"', {
        ...
        'msvs_disabled_warnings': [
          ...
          4310, 4428, 4481, 4505, 4510, 4512, 4530, 4610, 4611, 4701, 4706, 4996,
        ],
        'msvs_settings': {
          'VCCLCompilerTool': {
