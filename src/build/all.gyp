      ...
      'conditions': [
        ...
        ['OS=="win"', {
          'dependencies': [
            ...
            # ../chrome/test/AviatorSetup requires AviatorSetup.
            '../chrome/installer/mini_installer.gyp:AviatorSetup', # champion : app name change (amresh)
      ...
      'targets': [
        ...
        # subsets of a full tree for faster cycle times.
        {
          ...
          'dependencies': [
            ...
            '../content/content_shell_and_tests.gyp:copy_test_netscape_plugin',
            # ../chrome/test/AviatorSetup requires AviatorSetup.
            '../chrome/installer/mini_installer.gyp:AviatorSetup',
            '../courgette/courgette.gyp:courgette_unittests',
            '../device/device_tests.gyp:device_unittests',
            '../google_apis/gcm/gcm.gyp:gcm_unit_tests',
            '../gpu/gpu.gyp:gpu_unittests',
