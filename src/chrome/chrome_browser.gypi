  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'browser/championconfig/chromeimporter/chrome_profile_lock.cc',	      # champion : moved to championconfig (amresh)
        'browser/championconfig/chromeimporter/chrome_profile_lock.h',        # champion : moved to championconfig (amresh)
        'browser/championconfig/chromeimporter/chrome_profile_lock_posix.cc', # champion : moved to championconfig (amresh)
        'browser/championconfig/chromeimporter/chrome_profile_lock_win.cc',   # champion : moved to championconfig (amresh)
        ...
        'browser/net/chrome_extensions_network_delegate.h',       
 	      'browser/championconfig/connectioncontrol/control_ntml_http_auth.h',            # champion
 	      'browser/championconfig/connectioncontrol/control_ntml_http_auth.cc',           # champion   
        'browser/championconfig/connectioncontrol/rule_parser.h',                       # champion : for ntlm rule parsing (amresh)
        'browser/championconfig/connectioncontrol/rule_parser.cc',                      # champion : for ntlm rule parsing (amresh)         
      ...
      'conditions': [
        ...
        ['OS=="mac"', {
	'sources':[
	'browser/championconfig/warnbeforequitmac/DialogBoxController.mm', # champion warnbeforequit
        'browser/championconfig/warnbeforequitmac/DialogBoxController.h', # champion warnbeforequit
        'browser/championconfig/warnbeforequitmac/DailogsDelegate.mm', # champion warnbeforequit
        'browser/championconfig/warnbeforequitmac/DailogsDelegate.h', # champion warnbeforequit
        'browser/championconfig/warnbeforequitmac/QuitDialog.mm', # champion warnbeforequit
        'browser/championconfig/warnbeforequitmac/QuitDialog.h', # champion warnbeforequit
        'browser/championconfig/RestartUpdateMac/RestartDialog.mm', # Champion Added for RestartAviatorDialog browser for Update (Balaji)
        'browser/championconfig/RestartUpdateMac/RestartDialog.h',  # Champion Added for RestartAviatorDialog  browser for Update (Balaji)
        'browser/championconfig/show_disconnect_search_popup.h', # Champion Added for Disconnect search popup (Navneet)
        'browser/championconfig/show_disconnect_search_popup.mm', # Champion Added for Disconnect search popup (Navneet)
	],
	}],
	['OS=="win"', {
	'sources':[
	    'browser/championconfig/warnbeforequit/WarnBeforeQuit.h',      # champion : warn_before_quit (Dinesh)  	
        'browser/championconfig/warnbeforequit/WarnBeforeQuit.cc',     # champion : warn_before_quit (Dinesh) 
        'browser/championconfig/restartupdate/RestartforUpdate.h',     # champion : warn_before_quit (Dinesh)
        'browser/championconfig/restartupdate/RestartforUpdate.cc',    # champion : warn_before_quit (Dinesh)
	],
	}],
        ['OS=="win" or OS=="mac"', {
          'sources': [
        ...
        ['OS=="win"', {
          ...
          'dependencies': [
            ...
            '../chrome_elf/chrome_elf.gyp:Aviator_elf', # champion : re-brading (Amresh)
