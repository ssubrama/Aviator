...

{
  'variables': {
    'chrome_common_sources': [
      'browser/championconfig/connectioncontrol/connection_control_handler.cc', # champion 
      'browser/championconfig/connectioncontrol/connection_control_handler.h',  # champion     
      ...
      'browser/championconfig/chromeimporter/chrome_importer_utils.cc',     # champion : moved to championconfig (amresh)
      'browser/championconfig/chromeimporter/chrome_importer_utils.h',      # champion : moved to championconfig (amresh)
      'browser/championconfig/chromeimporter/chrome_importer_mac.mm',       # champion : moved to championconfig (amresh)
      'browser/championconfig/chromeimporter/chrome_importer_utils_win.cc', # champion : moved to championconfig (amresh)
