...
const wchar_t kGoogleRegClientStateKey[] =
    L"Software\\WhiteHat\\Aviator\\Update\\ClientState"; // champion : why Google (amresh)
const wchar_t kGoogleRegClientsKey[] = L"Software\\WhiteHat\\Aviator\\Update\\Clients"; // champion : why Google (amresh)
