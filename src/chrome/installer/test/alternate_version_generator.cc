...
namespace {
// champion : branding, optional (amresh)
...
const wchar_t kChrome7z[] = L"Aviator.7z";
const wchar_t kChromeBin[] = L"Aviator-bin";
const wchar_t kChromePacked7z[] = L"Aviator.packed.7z";
