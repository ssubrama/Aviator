...
const wchar_t kBrowserAppId[] = L"Aviator";
const wchar_t kBrowserProgIdPrefix[] = L"AviatorHTML";
const wchar_t kBrowserProgIdDesc[] = L"Aviator HTML Document";
...
base::string16 GetUninstallSurveyUrl() {
  const wchar_t kSurveyUrl[] = L"https://www.whitehatsec.com/aviator/help/"; // champion
  /*L"http://www.google.com/support/chrome/bin/"
