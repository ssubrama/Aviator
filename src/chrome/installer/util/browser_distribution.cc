...
base::string16 BrowserDistribution::GetBrowserProgIdPrefix() {
  ...
  return L"AviatorHTML"; // champion : chrome to aviator (amresh)
}

base::string16 BrowserDistribution::GetBrowserProgIdDesc() {
  return L"Aviator HTML Document"; // champion : chrome to aviator (amresh)
}
...
base::string16 BrowserDistribution::GetInstallSubDir2() {
  return L"WhiteHat\\Aviator";
}

base::string16 BrowserDistribution::GetPublisherName() {
  return L"WhiteHat Inc.";
}
...
base::string16 BrowserDistribution::GetUninstallLinkName() {
  return L"Uninstall Aviator";
}

base::string16 BrowserDistribution::GetUninstallRegPath() {
  return L"Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Aviator";
}
