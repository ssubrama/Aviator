...
const char kChrome[] = "Aviator"; //chrome to Aviator for champion :(utpal)
...
// Active Setup.
const wchar_t kActiveSetupExe[] = L"avtrstp.exe";
const wchar_t kChromeAppHostExe[] = L"app_host.exe";
const wchar_t kChromeDll[] = L"Aviator.dll"; // champion : app name change (amresh)
const wchar_t kChromeChildDll[] = L"Aviator_child.dll"; // champion : app name change (amresh)
...
const wchar_t kChromeLauncherExe[] = L"Aviator_launcher.exe";
const wchar_t kChromeMetroDll[] = L"metro_driver.dll";
const wchar_t kChromeNewExe[] = L"new_Aviator.exe"; // champion : app name change (amresh)
const wchar_t kChromeOldExe[] = L"old_Aviator.exe"; // champion : app name change (amresh)
...
const wchar_t kGoogleChromeInstallSubDir1[] = L"WhiteHat";  //Google to Aviator for champion :(utpal)
const wchar_t kGoogleChromeInstallSubDir2[] = L"Aviator"; //chrome to Aviator for champion :(utpal)
