...
const wchar_t kGoogleUpdateSetupExe[] = L"AviatorUpdateSetup.exe";

const wchar_t kRegPathClients[] = L"Software\\WhiteHat\\Aviator\\Update\\Clients";
const wchar_t kRegPathClientState[] = L"Software\\WhiteHat\\Aviator\\Update\\ClientState";
const wchar_t kRegPathClientStateMedium[] =
    L"Software\\WhiteHat\\Aviator\\Update\\ClientStateMedium";
const wchar_t kRegPathGoogleUpdate[] = L"Software\\WhiteHat\\Aviator\\Update";
