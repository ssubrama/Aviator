...
chrome.test.runTests([
  ...
  function setupTwoWindows() {
    createWindow(["about:blank", "aviator://newtab/", pageUrl("a")], {},
                pass(function(winId, tabIds) {
      secondWindowId = winId;
      testTabId = tabIds[2];

      createWindow(["aviator://newtab/", pageUrl("b")], {},
                           pass(function(winId, tabIds) {
        thirdWindowId = winId;
      }));
    }));
  ...
  function getAllInWindow() {
    chrome.tabs.getAllInWindow(secondWindowId,
      ...
      assertEq("aviator://newtab/", tabs[1].url);
    ...
    chrome.tabs.getAllInWindow(thirdWindowId,
      ...
      assertEq("aviator://newtab/", tabs[0].url);
