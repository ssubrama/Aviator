...
public final class SyncTestUtil {
    ...
    public static Map<Pair<String, String>, String> getAboutInfoStats(String rawJson)
        ...
        // What we get back is what you'd get from chrome.sync.aboutInfo at aviator://sync. This is
    ...
    /**
     * Retrieves the sync internals information which is the basis for aviator://sync-internals and
