...
#include "chrome/browser/championconfig/connectioncontrol/connection_control_handler.h" // champion NPCC
#include "chrome/browser/championconfig/connectioncontrol/connectioncontrolmanager.h" // champion NPCC
...
void RegisterProfilePrefs(user_prefs::PrefRegistrySyncable* registry) {
  ...
  options::ConnectionControlHandler::RegisterUserPrefs(registry); // champion NPCC
