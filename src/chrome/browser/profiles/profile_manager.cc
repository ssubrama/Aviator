...
Profile* ProfileManager::GetLastUsedProfile() {
  ...
  if (profile_manager) // champion : fix for keychain crash issue
...
void ProfileManager::CreateProfileAsync(
  ...
  if (iter != profiles_info_.end()) {
   ...
   profile->GetPrefs()->SetBoolean(prefs::kDefaultSearchPopUp,false);//champion - Default search popup - Dinesh  
