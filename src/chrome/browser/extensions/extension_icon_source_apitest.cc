...
IN_PROC_BROWSER_TEST_F(ExtensionIconSourceTest, MAYBE_IconsLoaded) {
  ...
  // Test that the icons are loaded and that the aviator://extension-icon
  ...
  // Verify that the an extension can't load aviator://extension-icon icons
...
IN_PROC_BROWSER_TEST_F(ExtensionIconSourceTest, InvalidURL) {
  ...
  ui_test_utils::NavigateToURL(
      browser(),
      GURL("aviator://extension-icon/invalid"));
