...
const PrepopulatedEngine* engines_GB[] =
    { &googleDisc, &bingDisc, &duckduckgoDisc, &yahooDisc, &google, &duckduckgo, &ask_uk, &yahoo_uk, &bing_en_GB, }; //champion_duckduckgo 
...
const PrepopulatedEngine* engines_IN[] =
    { &googleDisc, &bingDisc, &duckduckgoDisc, &yahooDisc, &google, &duckduckgo, &bing_en_IN, &yahoo_in, }; //Added for champion_duckduckgo for removing guruji
...
const PrepopulatedEngine* engines_US[] =
    { &googleDisc, &bingDisc, &duckduckgoDisc, &yahooDisc, &google, &duckduckgo, &bing_en_US, &yahoo, &aol, &ask, }; //added champion_duckduckgo
...
const PrepopulatedEngine* kAllEngines[] = {
  ...
  &duckduckgo,   &googleDisc,   &bingDisc,     &yahooDisc,    &duckduckgoDisc, // champion : our search engines
