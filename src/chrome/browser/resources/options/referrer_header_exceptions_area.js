...
cr.define('options.referrerHeader', function() {
  ...
  ExceptionsListItem.prototype = {
     ...
     */
    get pattern() {
      /*return this.dataItem['displayPattern']; champion referrer*/
       return this.dataItem.displayPattern;
    },
    set pattern(pattern) {
     /* this.dataItem['displayPattern'] = pattern; champion referrer*/
  ...
  function ReferrerHeaderExceptionsArea() {
    OptionsPage.call(this, 'referrerExceptions',loadTimeData.getString('referrerHeaderPageTabTitle'), 
                     'referrer-header-exceptions-area');
  }
  ...
  ReferrerHeaderExceptionsArea.prototype = {
    ...
    initializePage: function() {
      ...
      ReferrerHeaderExceptionsArea.hideOTRLists();
    ...
    showList: function(type) {
      ...
      header.textContent = "Referrer Header Exception";
   ...
   */
  ReferrerHeaderExceptionsArea.OTRProfileDestroyed = function() {
    this.hideOTRLists();
  };
   ...
   */
  ReferrerHeaderExceptionsArea.hideOTRLists = function() {
