...
cr.define('options', function() {
  ...
  CreateProfileOverlay.prototype = {
    ...
    updateCreateInProgress_: function(inProgress) {
      ...
      $('import-existing-managed-user-link').disabled = true; // champion : we need this to be hidden (navneet)
      //$('create-profile-throbber').hidden = !inProgress;
      $('create-profile-throbber').hidden = true; // champion : we need this to be hidden (navneet)
    },
