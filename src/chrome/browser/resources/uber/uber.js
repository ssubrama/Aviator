...
cr.define('uber', function() {
  ...
  /**
   * Changes the path past the page title (i.e. aviator://aviator/settings/(.*)).
  ...
  function showPage(pageId, historyOption, path) {
    ...
    $('favicon').href = 'aviator://theme/' + container.dataset.favicon;
    $('favicon2x').href = 'aviator://theme/' + container.dataset.favicon + '@2x';
