...
cr.define('options', function() {
   ...
   * @const
   */
  var CHROME_THEME_PATH = 'aviator://theme';
  ...
  UserImagesGridItem.prototype = {
    ...
    decorate: function() {
      ...
      // Force 1x scale for aviator://theme URLs. Grid elements are much smaller
  ...
  UserImagesGrid.ButtonImages = {
    TAKE_PHOTO: 'aviator://theme/IDR_BUTTON_USER_IMAGE_TAKE_PHOTO',
    CHOOSE_FILE: 'aviator://theme/IDR_BUTTON_USER_IMAGE_CHOOSE_FILE',
    PROFILE_PICTURE: 'aviator://theme/IDR_PROFILE_PICTURE_LOADING'
  };
