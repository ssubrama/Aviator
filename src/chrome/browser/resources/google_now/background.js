...
/* champion balaji help url redirect */ 
var SETTINGS_URL = 'https://www.whitehatsec.com/aviator/help/';
...
function getWeekNumber(d) {  
  ...
  var num = weekNr.toString() + d.getFullYear().toString();
  return num;    
}
 
/**
 * Description :- Calls to server to update the active user count - champion
 * Author      :- Sivakumar S 20/04/2014 
*/
...
/**
 * Description :- Add listener to new tab open and pings to server only one time for the current week - champion
 * Author      :- Sivakumar S 20/04/2014 
 */
