  ...
  HelpPage.prototype = {
    ...
    initialize: function() {
      ...
      $('get-help').onclick = function() {
        ...
        setTimeout(function() {window.open("https://www.whitehatsec.com/aviator/help/")},10); // champion added for report_an_issue
      };

      $('report-issue').onclick = function() {
      	chrome.send('openFeedbackDialog'); // blocked for  champion report_an_issue 
        // setTimeout(function(){window.open("https://www.whitehatsec.com/aviator/contactus/")},10); // champion added for report_an_issue
      };
