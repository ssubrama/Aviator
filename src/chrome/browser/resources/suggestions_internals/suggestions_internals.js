 ...
 * aviator://suggestions-internals/. This is used to debug suggestions ranking.
    ...
    list.forEach(function(entry) {
      ...
      columns.forEach(function(columnName) {
        ...
        if (typeof(data) != 'undefined') {
          ...
          var thumbnailUrl = 'aviator://thumb/' + entry.url;
          ...
          var faviconUrl = 'aviator://favicon/size/16@1x/' + entry.url;
