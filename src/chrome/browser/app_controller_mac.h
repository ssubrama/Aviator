...
extern bool brestartAviatorToTakeUpdate;
extern bool bshowAviatorRestartDialogAgain;
extern bool bQuitDockAndMenu; // champion WBQ Balaji
extern bool bDownloadInProgressShowed;     // champion : WBQ - Download is in progress warning dialog  (Balaji) 25July14
extern bool bquitFromDock; // champion navneet 
...
- (BOOL)tryToTerminateApplicationAndRestart:(NSApplication*)app; // champion restart browser when update is available balaji
...
- (void)removeObserverForWorkAreaChange:(ui::WorkAreaWatcherObserver*)observer;
 ...
 -(NSString*) GetUserName; //champion
 -(NSString*) GetAppXPath; //champion
...
void IsUpdateAvailable(); // Restart Aviator of upadte is available Champion Balaji
