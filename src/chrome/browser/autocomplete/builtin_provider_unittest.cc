...
TEST_F(BuiltinProviderTest, TypingScheme) {
  ...
  TestData typing_scheme_cases[] = {
    ...
    // Typing a portion of aviator:// should give the default urls.
    ...
    {ASCIIToUTF16("aviator://"), 3, {kURL1, kURL2, kURL3}},
  };
...
TEST_F(BuiltinProviderTest, TypingScheme) {
  ...
  TestData typing_scheme_cases[] = {
    ...
    {ASCIIToUTF16("aviator://"), 2, {kURL1, kURL2}},
  };
...
#if !defined(OS_ANDROID)
// Disabled on Android where we use native UI instead of aviator://settings.
