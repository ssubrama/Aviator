...
struct BookmarksTestInfo {
  ...
  { "aviator://version", "aviator://version" },
  { "aviator://omnibox", "aviator://omnibox" },
...
TEST_F(BookmarkProviderTest, InlineAutocompletion) {
  ...
  struct QueryData {
    ...
    { "chro", "aviator://version", true, "me://version" },
    { "aviator://ve", "aviator://version", true, "rsion" },
    { "chrome ver", "aviator://version", false, "" },
    { "versi", "aviator://version", false, "" },
    { "abou", "aviator://omnibox", false, "" },
    { "about:om", "aviator://omnibox", true, "nibox" }
...
TEST_F(BookmarkProviderTest, StripHttpAndAdjustOffsets) {
  ...
  struct QueryData {
    ...
    { "versi",     "aviator://version",           "0:1,9:3,14:1"          }
  };
