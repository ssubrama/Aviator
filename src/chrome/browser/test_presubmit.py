...
<include src="aviator://resources/totally-cool.css" />
...
<if expr="not is macosx">
  background-image: url(aviator://resources/BLAH); /* TODO(dbeam): Fix this. */
  background-color: rgb(235, 239, 249);
</if>
<if expr="is_macosx">
  background-color: white;
  background-image: url(aviator://resources/BLAH2);
</if>
  color: black;
}
...
html[dir=ltr] body /* TODO(dbeam): Require '' around rtl in future? */ {
  background: url("aviator://resources/BLAH");
