...
class ChromeProfileLock; //champion
class Importer;
class Profile;
...
class ExternalProcessImporterHost : public BaseBookmarkModelObserver {
 ...
 private:
  ...
  void ShowChromeWarningDialog(); //champion
  ...
  void OnImportLockDialogEndChrome(bool is_continue); //champion
  ...
  // Chrome profile lock.
  scoped_ptr<ChromeProfileLock> chrome_lock_; //added for champion

  bool is_chome_lock_; //champion - import bookmarks from chrome - Utpal
