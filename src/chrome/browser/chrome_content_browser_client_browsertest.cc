...
IN_PROC_BROWSER_TEST_F(ChromeContentBrowserClientBrowserTest,
  ...
  const GURL url_short("aviator://settings/");
  const GURL url_long("aviator://aviator/settings/");
...
IN_PROC_BROWSER_TEST_F(ChromeContentBrowserClientBrowserTest,
  ...
  const GURL url_short("aviator://settings/content");
  const GURL url_long("aviator://aviator/settings/content");
...
IN_PROC_BROWSER_TEST_F(ChromeContentBrowserClientBrowserTest,
  ...
  const GURL url("aviator://aviator/");
...
IN_PROC_BROWSER_TEST_F(ChromeContentBrowserClientBrowserTest,
  ...
  const GURL url("aviator://aviator//foo");
