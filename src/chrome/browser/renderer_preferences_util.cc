...
#include "../../net/http/http_request_headers.h" //champion_from_23
#include "../../net/http/http_util.h"            //champion_from_23
...
#endif
  // champion_from_23
  prefs->AlwaysOrNeverSendReferrer=profile->GetPrefs()->GetBoolean(prefs::kAllwaysOrNeverReferrersHeader);
  prefs->allow=*(net::HttpUtil::AllowVector);
  prefs->block=*(net::HttpUtil::BlockVector);
  //End
