...
public:
  ...
  //static WarnBeforeQuit* instance() { return instance_; } // champion: Different warn before quit for different window (Navneet)
  WarnBeforeQuit* instance() { return instance_; }
  ...
  // champion: Different warn before quit for different window (Navneet) start
  WarnBeforeQuit* instance_; 
  gfx::NativeWindow gptrNativeWnd; 
  gfx::NativeWindow gptrParentchild; 
  Browser* browser_ ; 
  bool* checkStockCloseType; 
  
  // champion: Different warn before quit for different window (End)
...
private:
  ...
  //static WarnBeforeQuit* instance_; // champion: Different warn before quit for different window (Navneet)
...
//bool Warnbeforequit(Operation operation, gfx::NativeWindow ptrNativeWnd, Browser* browser_, bool& checkStockCType); // champion: Different warn before quit for different window (Navneet)
bool Warnbeforequit(Operation operation, gfx::NativeWindow ptrNativeWnd, Browser* browser_, bool& checkStockCType, WarnBeforeQuit *warnBefoeQuit); 
// void Warnbeforequit2ndWindow(Operation operation); // champion: Different warn before quit for different window (Navneet)

void Warnbeforequit2ndWindow(Operation operation, WarnBeforeQuit *warnBefoeQuit);
