...
@implementation UnprotectedBubbleController

@synthesize nameTextField_=nameTextField_;

- (id)initWithParentWindow:(NSWindow*)parentWindow{
                   
  if ((self = [super initWithWindowNibPath:@"UnprotectedBubble"
...
- (void)showWindow:(id)sender {
  ...
  NSPoint arrowTip = bwc ? [bwc unprotectedBubblePoint] :
  ...
  NSString* title =l10n_util::GetNSString(IDS_UNPROTECTED_BUBBLE);
  [bigTitle_ setStringValue:title];
  
  NSString* info =l10n_util::GetNSString(IDS_UNPROTECTED_BUBBLE_TITLE_TEXT);
...
@end  // UnprotectedBubbleController
