...
#include "chrome/browser/championconfig/protectedunprotectedview/unprotected_promo_view.h"
...
UnProtectedPromoView::UnProtectedPromoView() {
  set_background(views::Background::CreateSolidBackground(kBackgroundColor));
  SetBorder (views::Border::CreateSolidSidedBorder(kBorderWidth, 0, 0, 0, kBorderColor));
  size_t offset;

  base::string16 link_text = l10n_util::GetStringUTF16(IDS_UNPROTECTED_BUBBLE_DESCRIPTION_TEXT_PROMO_LINK);
  base::string16 promo_text = l10n_util::GetStringFUTF16(
      IDS_UNPROTECTED_BUBBLE_DESCRIPTION_TEXT_PROMO_MESSAGE, link_text, &offset);
...
void UnProtectedPromoView::StyledLabelLinkClicked(const gfx::Range& range, int event_flags) {}
