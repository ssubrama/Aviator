...
#ifndef CHROME_BROWSER_UI_VIEWS_LOCATION_BAR_UNPROTECTED_BUBBLE_VIEW_H_
#define CHROME_BROWSER_UI_VIEWS_LOCATION_BAR_UNPROTECTED_BUBBLE_VIEW_H_
...
//#include "ui/views/controls/styled_label_listener.h" // champion
...
class UnProtectedBubbleView : public views::BubbleDelegateView  {
public:
  ...
  virtual ~UnProtectedBubbleView();

  // views::WidgetDelegate method.
  virtual void WindowClosing() OVERRIDE;

  //static views::View* anchor_view;
...
private:
  ...
  UnProtectedBubbleView(views::View* anchor_view );
  ...
  static UnProtectedBubbleView* unprotected_bubble_;
  ...
  DISALLOW_COPY_AND_ASSIGN(UnProtectedBubbleView);
};
