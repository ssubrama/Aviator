...
public:
  ...
  // we want to restart automatically when relaunch clicked in about window and hence static (Amresh)
  static int launchBrowserFromBrowser();
  static void LaunchWithoutPrompt();
 private:
