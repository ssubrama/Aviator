...
enum NotificationType {
  ...
  NOTIFICATION_CONNECTION_CONTROL_HANDLER_CHANGED, //added for champion
  ...
  //------------------------Purge Referrer Champion-----------------------------------
  // Sent when content settings change. The source is a HostContentSettings
  // object, the details are ContentSettingsNotificationsDetails.
  NOTIFICATION_REFERRER_SETTINGS_CHANGED,
  ...
  // Champion artf365916: Add Referer header controls in Advanced prefs (block all, site by site, or always send)
  // Champion sent when a referrer header has changed.
  NOTIFICATION_REFERRER_HEADER_REGISTRY_CHANGED, //Blocked for not getting add referrer for basics Error
  ...
  NOTIFICATION_PREF_CHANGED, // champion
