...
const char kSbReportPhishingErrorUrl[] = AVIATOR_HELP_URL; // champion balaji
  //  "http://www.google.com/safebrowsing/report_error/";

// URL for the "Learn more" link on the multi threat malware blocking page.
const char kLearnMoreMalwareUrl[] = AVIATOR_HELP_URL; // champion balaji
...
const char kLearnMoreMalwareUrlV2[] = AVIATOR_HELP_URL; // champion balaji
   // "https://www.google.com/goodtoknow/online-safety/malware/";
const char kLearnMorePhishingUrlV2[] = AVIATOR_HELP_URL; // champion balaji
   // "https://www.google.com/goodtoknow/online-safety/phishing/";

// URL for the "Learn more" link on the phishing blocking page.
const char kLearnMorePhishingUrl[] = AVIATOR_HELP_URL; // champion balaji
