...
// Champion artf414382 :    Build library on Mac      
#if defined (COOKIES_ALLOW_RECOMMENDED)  //CONTENT_SETTINGS_TYPE_COOKIES  made as compile time option for Cookies - Champion
  CONTENT_SETTING_ALLOW,    
#elif defined (COOKIES_ALLOW_CURRENT_SESSION)
  ...
  // Champion artf414382 :    Build library on Mac   
 #if defined (PLUGINS_BLOCK)  
  CONTENT_SETTING_BLOCK,     // CONTENT_SETTINGS_TYPE_PLUGINS          made as compile time option for plug ins - Champion 
 #elif defined (PLUGINS_ASK) //++ Champion_PLUGINS_ASK_58000
  CONTENT_SETTING_ASK,       //++  Champion_PLUGINS_ASK_58000
 #else
  CONTENT_SETTING_ALLOW,    // CONTENT_SETTINGS_TYPE_PLUGINS        
 #endif
  CONTENT_SETTING_BLOCK,    // CONTENT_SETTINGS_TYPE_POPUPS
  CONTENT_SETTING_ASK,      // CONTENT_SETTINGS_TYPE_GEOLOCATION
  CONTENT_SETTING_BLOCK,    // CONTENT_SETTINGS_TYPE_NOTIFICATIONS  // CHAMPION: aruna - to change default settings to block for notification
...
#endif
  CONTENT_SETTING_DEFAULT,  // CONTENT_SETTINGS_TYPE_REFERRER // CHAMPION ADDED 09-01-2013
};
