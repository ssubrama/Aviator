...
#include "chrome/browser/championconfig/varsconfig.h"  //for default block third party cookies
...
void CookieSettings::Factory::RegisterProfilePrefs(
	...
	/* Champion artf414382 Build library on Mac 	*/
    /* Champion artf360024 : ENABLE Block third-party cookies from being set  */

    
	if(BLOCK_THIRDPARTY_COOKIES)
      ...
      registry->RegisterBooleanPref(
        prefs::kBlockThirdPartyCookies,
      	false,
        user_prefs::PrefRegistrySyncable::SYNCABLE_PREF); // default false
}
