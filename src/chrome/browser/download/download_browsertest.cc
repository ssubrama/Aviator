...
// Test for crbug.com/14505. This tests that aviator:// urls are still functional
// after download of a file while viewing another aviator://.
...
// a aviator:// page that has registered and onunload handler, the browser
