...
class ProtectedDecoration;    // champion_protected added (Balaji)
class UnprotectedDecoration; //  champion_unprotected (Balaji)
...
class LocationBarViewMac : public LocationBar,
 ...
 public:
  ...
  NSPoint GetUnprotectedBubblePoint() const; // champion_unprotected (Balaji)
  NSPoint GetProtectedBubblePoint() const; // champion_protected added (Balaji)
  ...
  void mouseMovedUnProc (NSEvent* theEvent); // champion_unprotected (Balaji)
 ...
 private:
  ...
  void UpdateUnprotectedDecorationVisibility(); // champion_unprotected (Balaji)
  void UpdateProtectedDecorationVisibility(); // champion_protected added (Balaji)
  ...
  scoped_ptr<UnprotectedDecoration> unprotected_decoration_; // champion_unprotected (Balaji)
  scoped_ptr<ProtectedDecoration> protected_decoration_; // champion_protected added (Balaji)
