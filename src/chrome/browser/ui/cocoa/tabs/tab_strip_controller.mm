...
#import "chrome/browser/ui/cocoa/browser_window_controller.h" // champion added for Focus AddressBar by (Balaji)
#include "chrome/browser/ui/browser_window.h"                 // champion added for Focus AddressBar by (Balaji) 
...
- (void)clickNewTabButton:(id)sender {
  ...
  // champion added for Focus AddressBar by (Balaji) Start
   BrowserWindowController* bwc = [BrowserWindowController browserWindowControllerForWindow:
                                        browser_->window()->GetNativeWindow()];
   if (bwc)        
    [bwc focusLocationBar:true]; 
    // champion added for Focus AddressBar by (Balaji) End
}
