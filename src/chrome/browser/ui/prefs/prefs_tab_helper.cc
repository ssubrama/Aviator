...
PrefsTabHelper::PrefsTabHelper(WebContents* contents)
  ...
  if (prefs) {
    ...
    pref_change_registrar_.Add(prefs::kAllwaysOrNeverReferrersHeader, renderer_callback); // champion
...
void PrefsTabHelper::RegisterProfilePrefs(
  ...
  registry->RegisterBooleanPref(
      ...
      true,
      user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
  registry->RegisterBooleanPref(prefs::kAllwaysOrNeverReferrersHeader, // champion - purge referrer
      false,
