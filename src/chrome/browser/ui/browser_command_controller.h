...
extern bool HomeButtonClicked; //  champion artf831888 : Links (including links in mail) need to be opened in Protected mode
namespace content {
...
class BrowserCommandController : public CommandUpdaterDelegate,
 ...
 public:
  ...
  static int quitAll; // champion: To close all windows by one warn before quit dialogue from wrench menu (Navneet)
