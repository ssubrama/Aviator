...
#include "content/public/browser/download_manager.h" // champion navneet test 
#include "chrome/browser/ui/webui/options/browser_options_handler.h" //champion
...
using content::BrowserContext; // champion navneet test
...
void BrowserList::CloseAllBrowsersWithProfile(Profile* profile) {
  ...
  BrowserContext::GetDownloadManager(profile)->Shutdown(); // champion : added to cancel downloads when profile is deleted : navneet 
  BrowserContext::GetDownloadManager(profile->GetOffTheRecordProfile())->Shutdown();// champion : added to cancel downloads when profile is deleted : navneet 
  ...
  options::BrowserOptionsHandler::bUserProfileDeleted = false; // champion navneet test
  #endif	
}
