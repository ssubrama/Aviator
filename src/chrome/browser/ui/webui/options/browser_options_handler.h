...
class BrowserOptionsHandler
 ...
 private:
  ...
  // Enable the warn before quitting dialog. Called from WebUI.
  void EnableWarningDialogWhileQuit(const base::ListValue* args); //champion
  // Enable the notification key chain enabled. champion
  void notificationKeyChainEnabled(const base::ListValue* args);  
 ...
 public:
  // champion : no quit dialog on user profile deletion (Amresh)
  #if defined(OS_MACOSX)
  static bool bUserProfileDeleted;
  #endif
  #if defined(OS_WIN)
  static bool UserProfileDeleted;
  #endif
