...
// PrintPreviewUI serves data for aviator://print requests.
//
// The format for requesting PDF data is as follows:
// aviator://print/<PrintPreviewUIID>/<PageIndex>/print.pdf
//
// Parameters (< > required):
...
//
// Example:
//    aviator://print/123/10/print.pdf
//
// Requests to aviator://print with paths not ending in /print.pdf are used
...
PrintPreviewUI::PrintPreviewUI(content::WebUI* web_ui)
  ...
  // Set up the aviator://print/ data source.
