...
// Creates a WebUIDataSource for aviator://oobe
...
OobeUI::OobeUI(content::WebUI* web_ui, const GURL& url)
  ...
  // Set up the aviator://theme/ source, for Chrome logo.
  ThemeSource* theme = new ThemeSource(profile);
  content::URLDataSource::Add(profile, theme);

  // Set up the aviator://terms/ data source, for EULA content.
  ...
  // Set up the aviator://oobe/ source.
