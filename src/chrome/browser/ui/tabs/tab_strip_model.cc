...
bool TabStripModel::createshortcutcheck = false; // champion
...
WebContents* TabStripModel::DetachWebContentsAt(int index) {
  ...
  DCHECK(ContainsIndex(index));
  //champion - Dinesh create short cut application issue
  #if defined (OS_WIN)
  if(count()==1 && extensions::TabHelper::createShortcut) {
    TabStripModel::createshortcutcheck = true;
    extensions::TabHelper::createShortcut = false;
  }
  #endif
