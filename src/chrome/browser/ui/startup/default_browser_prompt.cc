...
#include "chrome/browser/ui/scoped_tabbed_browser_displayer.h" // champion : added for scopedtabbedbrowser object
...
bool DefaultBrowserInfoBarDelegate::Accept() {
  ...
  content::BrowserThread::PostTask(
      ...
      base::Bind(&SetChromeAsDefaultBrowser, interactive_flow_required_,
                 prefs_));
  // champion default browser
  /*chrome::ShowSettingsSubPage(browser::FindOrCreateTabbedBrowserDeprecated(
