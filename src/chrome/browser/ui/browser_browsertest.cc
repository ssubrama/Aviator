...
// and https and disabled for aviator://, about:// etc.
...
// Confirm aviator://version contains some expected content.
...
IN_PROC_BROWSER_TEST_F(BrowserTest, GetSizeForNewRenderView) {
  ...
  // Start with NTP.
  ui_test_utils::NavigateToURL(browser(), GURL("aviator://newtab"));
