...
extern bool bShowProtectedBubble; // champion added for Protected
extern bool bShowUnProtectedBubble; // champion added for UnProtected
...
class BrowserTabStripController; // champion : pre declaration (Amresh)
...
extern base::OneShotTimer<BrowserView> protected_timer_;   // champion protected
extern base::OneShotTimer<BrowserView> unprotected_timer_; // champion unprotected
...
class BrowserView : public BrowserWindow,
 ...
 public:
  ...
  BrowserTabStripController* tabstrip_controller_; // champion : our warn before quit needs this (amresh)
  ...
  void ShowProtectedBubble() ;   // champion added for protected
  void ShowUnProtectedBubble() ; // champion added for unprotected
  void HideProtectedBubble();    // champion added for protected
  void HideUnProtectedBubble();  // champion added for unprotected
  // champion : our warn before quit needs TabStripController (amresh)
  BrowserTabStripController* GetTabStipController() { return tabstrip_controller_; }
