...
class ZoomView;
class ProtectedView;   // champion added protected view
class UnProtectedView; // champion added Unprotected view
...
class LocationBarView : public LocationBar,
 ...
 public:
  ...
  ProtectedView* protected_view() { return protected_view_; }
  
  // Returns the star view. It may not be visible.
  UnProtectedView* unprotected_view() { return unprotected_view_; }
  ...
  virtual void OnMouseMoved(const ui::MouseEvent& event) OVERRIDE; // champion : added for protected/unprotected
#endif
 ...
 private:
  ...
  StarView* star_view_;
   ...
   // The Protected View . // champion added protected view
  ProtectedView* protected_view_;
  
  // The Protected View . // champion added unprotected view
  UnProtectedView* unprotected_view_;
