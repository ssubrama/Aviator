...
#if defined(OS_MACOSX) // champion WBQ (Balaji)
extern bool bCloseSingleTabAndWindow; // champion WBQ (Balaji)
extern bool bDIPYesClicked;  // champion Balaji WBQ -DOWNLOAD IN PROFRESS yes clicked
extern bool bDIPNoClicked;  // champion Balaji WBQ -DOWNLOAD IN PROFRESS yes clicked
#endif
...
class Browser : public TabStripModelObserver,
 ...
 public:
  ...
  // champion : let's check if exit is chrome type (amresh)
  bool IsExitStockType() const;
  bool IsCloseAllBrowser() const;
