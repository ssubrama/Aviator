...
void Home(Browser* browser, WindowOpenDisposition disposition); // champion : navneet - added for reload 
//void Home(Browser* browser, WindowOpenDisposition disposition, bool calledForReload = false);
