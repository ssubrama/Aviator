...
class ShellIntegration {
 public:
  ...
  //Added by utpal for getting default browser 
  static std::string GetDefaultBrowserForAviator(); //balaji
  //End 
  ...
  // champion start
  static bool IsSafariDefaultBrowser(); 
  static bool IsGoogleChromeDefaultBrowser();
  static bool IsIEDefaultBrowser(); 
  // champion end
