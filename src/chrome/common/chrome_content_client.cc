...
std::string GetProduct() {
  ...
  std::string product(USER_AGENT_STRING); //Added for champion for WhiteHat Champion User_Agent (Balaji)
  product += version_info.is_valid() ? version_info.ProductNameAndVersionForUserAgent() : std::string();
  return product;
}
