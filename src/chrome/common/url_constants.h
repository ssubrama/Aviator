...
// components below.
extern const char kChromeUIFeedbackURL1[]; // champion added
...
extern const char kChromeUINewUnprotectedWindowURL[]; //Added for champion for unprotected window
extern const char kChromeUIHomePageURL1[]; //Added for champion for focus of Home Page nov_29 2013
...
extern const char kAlternateBrowserSubPage[]; // champion added for alternate browser
...
extern const char kReferrerHeaderSubPage[];  // Referrer header page URL - Champion
extern const char kReferrerHeaderExceptionsSubPage[]; // Referrer header exceptions page URL - Champion
extern const char kConnectionControlSubPage[]; // Network port connection control page - Champion
...
// Gets the hosts/domains that are shown in aviator://aviator-urls.
