...
#define CHROMIUM_PRODUCT_STRING "Aviator"
#if defined(GOOGLE_CHROME_BUILD)
#define PRODUCT_STRING "Aviator"
...
#elif defined(CHROMIUM_BUILD)
#define PRODUCT_STRING_PATH L"Aviator" //champion branding(utpal)
#else
#error Unknown branding
#endif
...
const wchar_t kStatusTrayWindowClass[] = L"Aviator_StatusTrayWindow"; //champion branding(utpal)
#endif  // defined(OS_WIN)
...
const wchar_t kBrowserResourcesDll[] = L"Aviator.dll"; // champion : app name change (amresh)
