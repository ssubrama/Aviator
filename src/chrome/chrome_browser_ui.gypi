  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        #'browser/ui/cocoa/base_bubble_controller_aviator.h', # champion_protected added
        #'browser/ui/cocoa/base_bubble_controller_aviator.mm', # champion_protected added
        'browser/championconfig/protectedunprotectedviewmac/base_bubble_controller_aviator.h', # champion protected added , moved to championconfig (Balaji)
        'browser/championconfig/protectedunprotectedviewmac/base_bubble_controller_aviator.mm', # champion protected added, moved to championconfig (Balaji) 
	...
	#'browser/ui/cocoa/location_bar/unprotected_decoration.h', # champion added for unprotected popup alert
 	#'browser/ui/cocoa/location_bar/unprotected_decoration.mm', # champion added for unprotected popup alert
 	#'browser/ui/cocoa/location_bar/protected_decoration.h', # champion added for protected popup alert
 	#'browser/ui/cocoa/location_bar/protected_decoration.mm', # champion added for protected popup alert
 	#'browser/ui/cocoa/location_bar/unprotected_bubble_controller.h', # champion added for unprotected popup alert
 	#'browser/ui/cocoa/location_bar/unprotected_bubble_controller.mm', # champion added for unprotected popup alert
 	#'browser/ui/cocoa/location_bar/protected_bubble_controller.h', # champion added for protected popup alert
 	#'browser/ui/cocoa/location_bar/protected_bubble_controller.mm', # champion added for protected popup alert
        'browser/championconfig/protectedunprotectedviewmac/protected_bubble_controller.h', # champion added for protected popup alert, moved to championconfig (Balaji)
 	'browser/championconfig/protectedunprotectedviewmac/protected_bubble_controller.mm', # champion added for protected popup alert, moved to championconfig (Balaji)
 	'browser/championconfig/protectedunprotectedviewmac/protected_decoration.h', # champion added for protected popup alert, moved to championconfig (Balaji)
 	'browser/championconfig/protectedunprotectedviewmac/protected_decoration.mm', # champion added for protected popup alert, moved to championconfig (Balaji)
 	'browser/championconfig/protectedunprotectedviewmac/unprotected_bubble_controller.h', # champion added for unprotected popup alert, moved to championconfig (Balaji)
 	'browser/championconfig/protectedunprotectedviewmac/unprotected_bubble_controller.mm', # champion added for unprotected popup alert, moved to championconfig (Balaji)  
 	'browser/championconfig/protectedunprotectedviewmac/unprotected_decoration.h', # champion added for unprotected popup alert, moved to championconfig (Balaji)
 	'browser/championconfig/protectedunprotectedviewmac/unprotected_decoration.mm', # champion added for unprotected popup alert, moved to championconfig (Balaji)
	'browser/ui/cocoa/location_bar/search_button_decoration.h',
        ...
        'browser/championconfig/feedbackui/feedback_ui.cc',       # champion : moved to championconfig (amresh)
        'browser/championconfig/feedbackui/feedback_ui.h',        # champion : moved to championconfig (amresh)
        ...
        'browser/championconfig/addreferrer/referrer_header_handler.cc',           # champion : moved to championconfig (amresh)
        'browser/championconfig/addreferrer/referrer_header_handler.h',            # champion : moved to championconfig (amresh)
        'browser/championconfig/addreferrer/referrer_header_exception_handler.cc', # champion : moved to championconfig (amresh)
        'browser/championconfig/addreferrer/referrer_header_exception_handler.h',  # champion : moved to championconfig (amresh)
      ...
      'conditions': [
        ...
        ['OS=="win"', {
          'sources': [
        'browser/championconfig/protectedunprotectedview/protected_view.cc',         # champion : moved to championconfig (amresh)
        'browser/championconfig/protectedunprotectedview/protected_view.h',          # champion : moved to championconfig (amresh)
        'browser/championconfig/protectedunprotectedview/unprotected_view.cc',       # champion : moved to championconfig (amresh)
        'browser/championconfig/protectedunprotectedview/unprotected_view.h',        # champion : moved to championconfig (amresh)
        'browser/championconfig/protectedunprotectedview/protected_bubble_view.cc',  # champion : moved to championconfig (amresh)
        'browser/championconfig/protectedunprotectedview/protected_bubble_view.h',   # champion : moved to championconfig (amresh)
        'browser/championconfig/protectedunprotectedview/unprotected_bubble_view.cc',# champion : moved to championconfig (amresh)
        'browser/championconfig/protectedunprotectedview/unprotected_bubble_view.h', # champion : moved to championconfig (amresh)
        'browser/championconfig/protectedunprotectedview/protected_promo_view.cc',   # champion : moved to championconfig (amresh)
        'browser/championconfig/protectedunprotectedview/protected_promo_view.h',    # champion : moved to championconfig (amresh)
        'browser/championconfig/protectedunprotectedview/unprotected_promo_view.cc', # champion : moved to championconfig (amresh)
        'browser/championconfig/protectedunprotectedview/unprotected_promo_view.h',  # champion : moved to championconfig (amresh)
        'browser/championconfig/serverlistparser/server_list_parser.cc', # champion : for server list file (amresh)
        'browser/championconfig/serverlistparser/server_list_parser.h',  # champion : for server list file (amresh)
        'browser/championconfig/serverlistparser/SHA1.cc',               # champion : for server list file (amresh)
        'browser/championconfig/serverlistparser/SHA1.h',                # champion : for server list file (amresh)
        'browser/ui/webui/help/help_ui.cc',
	  ],
        }],  
