  ...
  'targets': [
    {
      ...
      'dependencies': [
        ...
        'common',
        'browser',#champion added for static library linker issue fix:( utpal )
      ...
      'sources': [
        ...
        'browser/championconfig/ChromeImporter/chrome_importer.cc', #added for champion Aviator import bookmarks for chrome
        'browser/championconfig/ChromeImporter/chrome_importer.h',#end
