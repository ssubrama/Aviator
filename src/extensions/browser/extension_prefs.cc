...
void ExtensionPrefs::OnExtensionInstalled(
  ...
  PopulateExtensionInfoPrefs(extension,
                             ...
                             install_parameter,
                             extension_dict);
  /*Added for Installing extension incognito mode also*/   //default extension should install in incognito mode also                                           	                     	
  extension_dict->Set(kPrefIncognitoEnabled,Value::CreateBooleanValue(true));//added for champion for installing extension in incognito mode  
  /*End */ 
