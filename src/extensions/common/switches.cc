...
// Enables extensions running scripts on aviator:// URLs.
// Extensions still need to explicitly request access to aviator:// URLs in the
// manifest.
...
// Makes component extensions appear in aviator://settings/extensions.
