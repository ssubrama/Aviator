...
bool HasOnlySecureTokens(base::StringTokenizer& tokenizer,
  ...
  while (tokenizer.GetNext()) {
    ...
    if (source == "'self'" ||
        ...
        StartsWithASCII(source, "aviator://", true) ||  // champion added for bookmark internal url
        StartsWithASCII(source, "champion://", true) ||  // champion added for bookmark internal url
