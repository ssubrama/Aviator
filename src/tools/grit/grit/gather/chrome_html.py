...
_THEME_SOURCE = lazy_re.compile(
    '(?P<baseurl>aviator://theme/IDR_[A-Z0-9_]*)(?P<query>\?.*)?')
...
def GetImageList(
  ...
  aviator://theme/ source, inserts supported @Nx scale factors as high DPI
  versions.
...
def UrlToImageSet(
  ...
  factors. If the file is from a aviator://theme/ source, inserts the
