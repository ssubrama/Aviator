...
def GetConfigurationForBuild(defines):
  ...
  if '_chromium' in defines:
    config = {
      'build': 'Aviator',
      'app_name': 'Aviator',
      'frame_name': 'Aviator Frame',
      'os_name': 'Chromium OS',
      'win_reg_mandatory_key_name': 'Software\\Policies\\WhiteHat\\Aviator',
      'win_reg_recommended_key_name':
          'Software\\Policies\\WhiteHat\\Aviator\\Recommended',
      'win_mandatory_category_path': ['Aviator'],
      'win_recommended_category_path': ['chromium_recommended'],
      'admx_namespace': 'Aviator.Policies.Aviator',
      'admx_prefix': 'Aviator',
    }
